  ...
  return (
    <div className="md:w-2/3 mb-12 md:mb-0">
      ...
      <p className="text-lg max-w-2xl mb-4 leading-relaxed text-gray-300">
        ...
        clean and well-documented code, system architecture and cross-functional
        collaboration. Fast learner that continuously evolves through challenges
        in both agile startups and global corporate ecosystems.
      </p>
    </div>
  );
};
